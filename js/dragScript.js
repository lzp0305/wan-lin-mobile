      ...
      if(!editing){
          ...
          document.addEventListener('mousemove',function(e) {
            ...
            if(moving === true){
              ...
              tgt.setAttribute('dx', dx );
              tgt.setAttribute('dy', dy );
            };
          });
          document.addEventListener('touchmove',function(e) {
            ...
            if(moving === true){
              for(let i = 0; i < touches.length; i++){
                  ...
                  var dy = touches[i].pageY - offsetY;
                  var tt = $('.publish').attr('bd')
                  // Apply the styles to the element
                  var position = 'transform: translate('+dx+'px, '+dy+'px);z-index:'+z+';top:'+tt+';';
                  tgt.setAttribute('style', position);
                  tgt.setAttribute('dx', dx );
                  tgt.setAttribute('dy', dy );
              }
